    ...
    <section id="about" className="bg-background py-24">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mx-auto mt-8 max-w-xl text-left text-base leading-relaxed text-foreground/80">
          ...
          development technology. We want the world to experience a diverse
          narrative right from the heart of Africa developed by a local team of
          creative, skilled and passionate gamers.
        </p>
      </div>
    </section>
  )
