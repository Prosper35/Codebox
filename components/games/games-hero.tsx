  ...
  return (
    <section className="relative overflow-hidden bg-black">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 pt-24 pb-20 md:pt-28 md:pb-28">
        <h1 className="text-center font-display text-4xl font-bold tracking-tight text-white md:text-6xl">
          Our Games
        </h1>
        <p className="mx-auto mt-8 max-w-2xl text-left leading-relaxed text-white/85 md:text-lg">
