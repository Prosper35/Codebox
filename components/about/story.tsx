    ...
    <section className="bg-brand text-brand-foreground">
      <div className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <p className="mx-auto mt-8 max-w-2xl text-sm leading-relaxed text-brand-foreground/80">
          ...
          Orisha: Blood and Water&rdquo; where players are introduced to a
          magical action-packed adventure in the untapped world of African
          Fantasy. Legends of Orisha is currently in-development using Unreal
          Engine 5 to showcase the high fidelity and latest technology from Epic
          Games.
        </p>
      </div>
    </section>
